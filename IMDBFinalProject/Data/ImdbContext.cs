...
public partial class ImdbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            // Fetch the connection string by name from app.config
            var connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["IMDBDatabase"].ConnectionString;
